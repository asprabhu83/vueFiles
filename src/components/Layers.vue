<template>
  ...
  >
    ...
    <div class="flex items-center justify-between my-4" @click='getAllFrames(project)'>
        <div class="w-16">
        <img class="w-12 h-12 rounded-full" :src="'http://drill.siteguru.co.il/uploads/'+project.image_Location+'/thumb_0.jpg'">
        </div>
...
export default {
  ...
  created () {
    this.axios.get('https://drill.siteguru.co.il/api/getProjects')
      .then(x => {
